...
#' @format A data frame with 664 rows and 3 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 10210 rows and 4 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 7093 rows and 4 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 2426 rows and 11 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 2341 rows and 4 variables:
#' \describe{
