...
#' @format A data frame with 230 rows and 3 variables:
#' \describe{
...
#' @title CONCEPT
#' @description DATASET_DESCRIPTION
#' @format A data frame with 28111 rows and 10 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 262554 rows and 3 variables:
#' \describe{
#'   \item{\code{concept_id}}{double COLUMN_DESCRIPTION}
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 3467 rows and 4 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 2469 rows and 4 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 1001 rows and 11 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 236 rows and 3 variables:
#' \describe{
