...
#' @format A data frame with 835 rows and 3 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 12401 rows and 4 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 8647 rows and 4 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 3429 rows and 11 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 2817 rows and 4 variables:
#' \describe{
