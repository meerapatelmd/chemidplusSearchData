...
#' @format A data frame with 708 rows and 3 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 10730 rows and 4 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 7396 rows and 4 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 2445 rows and 4 variables:
#' \describe{
