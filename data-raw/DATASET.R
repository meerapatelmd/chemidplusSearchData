...
CONCEPT_DEPRECATION <- broca::simply_read_csv('/Users/patelm9/GitHub/Public-Packages/chemidplusSearchData//data-raw//CONCEPT_DEPRECATION.csv')
...
usethis::use_data(CLASSIFICATION,CONCEPT,CONCEPT_DEPRECATION,CONCEPT_SYNONYM,LINKS_TO_RESOURCES,NAMES_AND_SYNONYMS,REGISTRY_NUMBER_LOG,REGISTRY_NUMBERS,RN_URL_VALIDITY, overwrite = TRUE)
