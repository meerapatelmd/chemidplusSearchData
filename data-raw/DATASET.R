...
CONCEPT <- readr::read_csv('/Users/patelm9/GitHub/Public-Packages/chemidplusSearchData/data-raw/CONCEPT.csv')
CONCEPT_SYNONYM <- readr::read_csv('/Users/patelm9/GitHub/Public-Packages/chemidplusSearchData/data-raw/CONCEPT_SYNONYM.csv')
